...
const note = [
  ...
  "Роли вызываются как /<role>:vorcl. Основные маршруты: architect, principal-architect, backend, frontend, expo-mobile, analyzer, integrity, swagger, firecrawl, render, database, resilience, logging, screenshot, design-studio, visual-research, pinpoint, drawio, archmap, mermaid, testing, gitflow, security, docs, devops, liveboard.",
