...
description: Проектирование/ревью схемы и целостности данных (роль database). Use when проектируем новую сущность или ревьюим форму существующей; менять готовую схему — $database-migrate.
---
