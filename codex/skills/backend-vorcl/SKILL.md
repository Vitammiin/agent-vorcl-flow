---
name: backend-vorcl
description: Точка входа в Task Master workflow для цели (роль backend). Use when нужно довести серверную цель (API, модули, интеграции) через цикл задач Task Master до реализованного и протестированного результата.
---
