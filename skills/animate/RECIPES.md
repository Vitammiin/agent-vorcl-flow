...
- [Tab indicator with a color transition](#tab-indicator-with-a-color-transition)
- [Scroll reveal](#scroll-reveal)
- [Drag to dismiss](#drag-to-dismiss)
- [Masking a crossfade that won't settle](#masking-a-crossfade-that-wont-settle)
- [Programmatic, without a library](#programmatic-without-a-library)
