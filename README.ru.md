...
## Лицензия
Проприетарная «use-only» — свободное использование всеми, без копирования/распространения и изменений, без гарантий и ответственности. См. [LICENSE](./LICENSE). © 2026 Christian Avis and Vorcl.
