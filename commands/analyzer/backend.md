---
description: Поиск «плохого» кода на бэкенде — нарушения архитектуры, логика в контроллерах. Use when ищем нарушения слоёв и структуры бэка; конкретные баги поведения — /analyzer:bugs (analyzer)
