...
- `~/.cursor/agents/avf-<name>.md` — 24 custom subagents с `model: inherit`; read-only роли получают `readonly: true`. Префикс `avf-` не даёт именам конфликтовать со скиллами-персонами.
