...
skills: [screenshot-to-code, react, nextjs, typescript, tailwind, frontend-architecture, workflow, task-master]
---
...
## Навыки
Опирайся на: **screenshot-to-code** (полный процесс разбора → кода), **tailwind** (v4, `@theme`, OKLCH, cva/cn, container queries), **react** и **nextjs** (компоненты, Server/Client), **typescript** (типы пропсов), **frontend-architecture** (feature-структура для многокомпонентного UI).
