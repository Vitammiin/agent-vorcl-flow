...
skills: [backend-architecture, nodejs, typescript, postgresql, redis, vercel, render, workflow, task-master]
---
...
## Навыки
Опирайся на скиллы плагина: **backend-architecture**, **nodejs**, **typescript**, **postgresql**, **redis**, **vercel** (деплой/логи/проекты через MCP), **render** (деплой/редеплой, логи, метрики, Render Postgres/Key Value, env-переменные через MCP).
